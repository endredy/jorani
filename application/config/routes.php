...
$route['users/editLimited/(:num)'] = 'users/editLimited/$1'; // esteve
...
$route['hr/employees/groups'] = 'hr/groups'; // esteve
$route['hr/employees/groups/edit/(:any)/(:num)'] = 'hr/editGroups/$1/$2'; // esteve
...
$route['leaves/createM'] = 'leaves/createM'; // esteve
